...
<div class="col-lg-9  mt-2">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <!-- Modal Menu Tambah Baru -->
            <div class="modal fade" id="ModalTambahUser" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Tanaman</h1>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <label class="input-group-text" for="uploadFoto">Upload Foto Tanaman</label>
                                            <div class="invalid-feedback">
                                                Masukan File Foto Tanaman
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floatingInput">Nama Tanaman</label>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" aria-label="Default select example"
                                                ...
                                                <option selected hidden value="">Pilih Kategori Tanaman</option>
                                                <?php
                                            ...
                                            <label for="floatingInput">Kategori Tanaman</label>
                                            <div class="invalid-feedback">
                                                Pilih Kategori Tanaman
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
            ...
            foreach ($result as $row) {
                ...
                <div class="modal fade" id="ModalDelete<?php echo $row['id'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Delete Data Tanaman</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_menu.php"
                                    ...
                                    <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                    <div class="col-lg-12">
                                        Apakah ingin menghapus Tanaman <b>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="width:180px">
                                            <img src="../Batamera/assets/images/<?php echo $row['foto'] ?>"
                                    ...
                                    <td>
                                        <?php echo ($row['jenis_menu'] == 1) ? "Minuman" : "Makanan" ?>
                                    </td>
                                    <td>
